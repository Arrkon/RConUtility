...
{
    [Serializable]
    public class CountupTicker : ITicker
    {
        [ShowInInspector][HideLabel] private const string typeLabel = "Count Up";
        ...
        public float Percent => _currentTime / _counterTime;
        ...
        public CountupTicker(float maxTime)
        {
